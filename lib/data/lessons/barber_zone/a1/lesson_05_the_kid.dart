...
const lesson05TheKid = Lesson(
  ...
  exercises: [
    ...
    // Frase y opciones SOLO L04 ✓
    {
      ...
      'traduccion_pregunta': '¿Tiene una cita? No ___',
    ...
    // Opciones: partes de las expresiones L05 ✓
    {
      ...
      'traduccion_pregunta': 'Por favor tome asiento, mi ___',
      'respuesta_correcta': 'son',
    ...
    // Frase usa L03+L04 / opciones son partes de L05 ✓
    {
      ...
      'traduccion_pregunta': 'Un corte ___, por favor',
      'respuesta_correcta': 'modern',
    ...
    // Respuesta correcta: No problem (L04) + Take a seat (L02)
    {
      ...
      'frase': 'Good morning! Modern haircut for my son',
      'traduccion_pregunta': '¡Buenos días! Corte moderno para mi hijo',
      'cliente_dice': 'Good morning! Modern haircut for my son',
      'traduccion_cliente': '¡Buenos días! Corte moderno para mi hijo',
