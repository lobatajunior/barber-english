...
const lesson02TakeASeat = Lesson(
  ...
  exercises: [
    ...
    // Opciones: partes de las 4 expresiones L02 ya enseñadas ✓
    {
      ...
      'quien_habla': 'Tú le dices',
      'frase': "___ your name?",
      'traduccion_pregunta': '¿___ tu nombre?',
    ...
    // Frase y opciones usan SOLO palabras de L02 ✓
    {
      ...
      'traduccion_pregunta': 'Me llamo Junior, ___ asiento',
    ...
    // Respuesta correcta: Of course (L01) + Come in (L01) + Take a seat (L02)
    {
      ...
      'frase': 'Good morning! I have an appointment with you',
      'traduccion_pregunta': 'Buenos días, tengo una cita contigo',
      'cliente_dice': 'Good morning! I have an appointment with you',
      'traduccion_cliente': 'Buenos días, tengo una cita contigo',
