...
const lesson03TheCut = Lesson(
  ...
  exercises: [
    ...
    // Frase usa L01 + L02 — opciones son partes de L02 ✓
    {
      ...
      'traduccion_pregunta': '¡Buenos días! Pase, ___ asiento',
    ...
    // Opciones: todas de L03 ✓
    {
      ...
      'traduccion_pregunta': 'Quiero un ___ en los lados',
      'respuesta_correcta': 'fade',
    ...
    // Frase y opciones usan SOLO palabras de L03 ✓
    {
      ...
      'traduccion_pregunta': 'Degradado en los ___, más largo arriba',
      'respuesta_correcta': 'sides',
    ...
    // Opciones usan SOLO palabras de L01 + L02 + L03 ✓
    {
      ...
      'frase': 'I want a fade on the sides, longer on top',
      'traduccion_pregunta': 'Quiero un degradado en los lados, más largo arriba',
      'cliente_dice': 'I want a fade on the sides, longer on top',
      'traduccion_cliente':
          'Quiero un degradado en los lados, más largo arriba',
